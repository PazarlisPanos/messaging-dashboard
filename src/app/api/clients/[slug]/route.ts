...
export async function PATCH(req: NextRequest, { params }: { params: { slug: string } }) {
  ...
  const allowed = role === 'super_admin'
    ? ['name', 'database_url', 'wa_webhook', 'vb_webhook', 'bot_toggle_webhook', 'resolve_attention_webhook', 'fb_webhook', 'fb_page_id']
    : ['name', 'wa_webhook', 'vb_webhook', 'bot_toggle_webhook', 'resolve_attention_webhook', 'fb_webhook', 'fb_page_id']
